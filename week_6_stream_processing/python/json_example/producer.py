    ...
    def publish_rides(self, topic: str, messages: List[Ride]):
        for ride in messages:
            try:
                ...
                print('Record {} successfully produced at offset: {}, topic: {}, partition: {}, timestamp: {}, serialized_key_size: {} '.format(ride.pu_location_id, record.get().offset, record.get().topic, record.get().partition, record.get().timestamp, record.get().serialized_key_size))
